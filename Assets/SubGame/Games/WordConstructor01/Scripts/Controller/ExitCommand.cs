...
{
    public sealed class ExitCommand : SubGameExitCommandBase<WordConstructor01Settings, WordConstructor01UserData, WordConstructor01Level, WordConstructor01Stage>
    {
        [Inject]
