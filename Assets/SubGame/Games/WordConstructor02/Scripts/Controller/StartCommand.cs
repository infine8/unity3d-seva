...
{
    public sealed class StartCommand : SubGameStartCommandBase<WordConstructor02Settings, WordConstructor02UserData, WordConstructor02Level, WordConstructor02Stage>
    {
        [Inject]
