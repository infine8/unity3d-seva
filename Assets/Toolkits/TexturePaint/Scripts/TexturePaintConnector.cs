...
{
	if(totalColorActorId < colorActorArraySize)
	{
		colorActorHistoryArray[totalColorActorId] = colorDetails;
	}
	...
	return Mathf.Clamp(totalColorActorId, 0, colorActorArraySize);
}
