...
public class AudioController : SingletonMonoBehaviour<AudioController>
{
    ...
    public static AudioObject PlayAfter(string firstAudioId, string secondAudioId, float delay = 0.5f)
    {
        var firstSound = Play(firstAudioId);

        return PlayAfter(secondAudioId, firstSound, 0, 1, firstSound.clipLength + delay);
    }
